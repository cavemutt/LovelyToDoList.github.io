...
const tourArray = ['#bubble-intro', '#app-title', '#background-tour-stop', '#volume-container', '#reset-button', '#to-do-list-title',  '#input-form', '#select-container', '#list-length-p', '#to-do-list-ul', '#bubble-outro' ]
...
function bubbleIndicator(el) {
    ...
    // X position
    elLeft <= bodyLeft + 20 ? bubbleIndicatorDot.style.left = (elLeft + 40) + 'px' : bubbleIndicatorDot.style.left = (elLeft - 60) + 'px'
...
// add a sample list item for the tour
    if(tourCounter === 6) {
        todoBtn.click()
    }
